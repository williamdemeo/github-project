"""
File: scripts/_utils/file_ops.py
...
Provenance:
  ...
  item 3 (calculate_file_metadata's ProcessingStage annotation was
  never imported).  Downstream projects re-vendor from here.
"""
...
from .pipeline_types import (
    Result, PipelineError, ErrorType, FileMetadata, ProcessingStage,
)
